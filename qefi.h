...
public:
    ...
    QEFIDevicePathType type() const
    {
        return m_type;
    }
    quint8 subType() const
    {
        return m_subType;
    }
};
...
public:
    QEFIDevicePathBIOSBoot(quint16 deviceType, quint16 status, QByteArray description)
        : QEFIDevicePath(QEFIDevicePathType::DP_BIOSBoot, QEFIDevicePathBIOSBootSubType::BIOS_BIOSBoot)
...
public:
    ...
    // Rule of Five: explicitly delete copy operations since we manage resources
    QEFILoadOption(const QEFILoadOption &) = delete;
    QEFILoadOption &operator=(const QEFILoadOption &) = delete;

    // Move operations are defaulted
    QEFILoadOption(QEFILoadOption &&) = default;
    QEFILoadOption &operator=(QEFILoadOption &&) = default;
    ...
    const QByteArray &optionalData() const;
    const QList<QSharedPointer<QEFIDevicePath>> &devicePathList() const;
...
public:
    QEFIDevicePathHardwareMMIO(quint32 memoryType, quint64 startingAddress, quint64 endingAddress);
    quint32 memoryType() const
    {
        return m_memoryType;
    }
    quint64 startingAddress() const
    {
        return m_startingAddress;
    }
    quint64 endingAddress() const
    {
        return m_endingAddress;
    }
};
...
public:
    QEFIDevicePathACPIHIDEX(quint32 hid, quint32 uid, quint32 cid, QString hidString, QString uidString, QString cidString);
    quint32 hid() const
    {
        return m_hid;
    }
...
public:
    QEFIDevicePathMessageFibreChan(quint32 reserved, quint64 wwn, quint64 lun);
...
public:
    QEFIDevicePathMessageInfiniBand(quint32 resourceFlags, quint64 portGID1, quint64 portGID2, quint64 sharedField, quint64 targetPortID, quint64 deviceID);
...
public:
    ...
    quint8 interfaceType() const;
    QEFIDevicePathMessageMACAddress macAddress() const
    {
        return m_macAddress;
    }
};
...
public:
    QEFIDevicePathMessageIPv4Addr(quint8 *localIPv4Addr,
...
public:
    QEFIDevicePathMessageIPv6Addr(quint8 *localIPv6Addr,
...
public:
    QEFIDevicePathMessageUART(quint32 reserved, quint64 baudRate, quint8 dataBits, quint8 parity, quint8 stopBits);
    quint32 reserved() const;
...
public:
    QEFIDevicePathMessageUSBClass(quint16 vendorId, quint16 productId, quint8 deviceClass, quint8 deviceSubclass, quint8 deviceProtocol);
...
public:
    QEFIDevicePathMessageUSBWWID(quint16 vendorId, quint16 productId, quint16 *sn);
    quint16 vendorId() const;
    quint16 productId() const;
...
public:
    QEFIDevicePathMessageSATA(quint16 hbaPort, quint16 portMultiplierPor, quint8 lun);
...
public:
    QEFIDevicePathMessageISCSI(quint16 protocol, quint16 options, quint8 *lun, quint16 tpgt, QString targetName);
    quint16 protocol() const;
...
public:
    QEFIDevicePathMessageFibreChanEx(quint32 reserved, quint8 *wwn, quint8 *lun);
...
public:
    QEFIDevicePathMessageSASEx(quint8 *sasAddress, quint8 *lun, quint8 deviceTopologyInfo, quint8 driveBayID, quint16 rtp);
...
public:
    QEFIDevicePathMessageNVME(quint32 namespaceID, quint8 *ieeeEui64);
...
public:
    QEFIDevicePathMediaHD(quint32 partitionNumber, quint64 start, quint64 size, quint8 *signature, quint8 format, quint8 signatureType);
    quint32 partitionNumber() const
    {
    ...
    quint32 mbrSignature() const
    {
        return m_mbrSignature;
    }
    const quint8 *rawSignature() const
    {
        return m_signature;
    }
...
public:
    ...
    quint32 bootCatalogEntry() const
    {
        return m_bootCatalogEntry;
    }
    quint64 partitionRba() const
    {
        return m_partitionRba;
    }
...
public:
    QEFIDevicePathMediaRelativeOffset(quint32 reserved, quint64 firstByte, quint64 lastByte);
    quint32 reserved() const
    {
        return m_reserved;
    }
    quint64 firstByte() const
    {
        return m_firstByte;
    }
    quint64 lastByte() const
    {
        return m_lastByte;
    }
};
...
public:
    QEFIDevicePathMediaRAMDisk(quint64 startAddress, quint64 endAddress, QUuid diskTypeGuid, quint16 instanceNumber);
    ...
    QUuid diskTypeGuid() const
    {
        return m_diskTypeGuid;
    }
    quint16 instanceNumber() const
    {
